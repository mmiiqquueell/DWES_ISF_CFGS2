...
<html>
	...
	<body>
		...
		<form name="formulario" method="get" action="04_accion.php">
			<input type="text" placeholder="Nombre" name="name"></input><br>
			<input type="text" placeholder="Edad" name="age"></input><br>
			<input type="text" placeholder="Email" name="mail"></input><br>
			<input type="text" placeholder="Sexo" name="sex"></input><br><br>
			<b>Aficiones</b><br>
